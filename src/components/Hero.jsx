      ...
      <div className="container">
        <div className="hero-content">
          ...
          <h1 className="hero-title">
            {personal.fullName}
            <span className="title-role">{personal.title}</span>
          </h1>
          ...
          {/* Architectural Milestones Strip */}
          <div className="hero-metrics">
            {about.milestones.map((m, idx) => (
              <div key={idx} className="metric-strip-card">
                <div className="metric-strip-num">{m.metric}</div>
                <div className="metric-strip-label">{m.label}</div>
                <div className="metric-strip-detail">{m.detail}</div>
              </div>
            ))}
          </div>
        </div>
